...
export function Button({
  ...
  const classList = `flex w-full items-center justify-center rounded-md border border-transparent bg-rose-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 transition-all duration-150 cursor-pointer disabled:cursor-not-allowed disabled:bg-rose-500 disabled:hover:bg-rose-500 ${className}`;
