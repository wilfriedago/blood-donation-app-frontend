              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="block w-full appearance-none rounded-md border border-gray-400 px-3 py-2 shadow-sm placeholder:text-gray-400 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                  />
                </div>
              </div>
              {errors?.email && (
